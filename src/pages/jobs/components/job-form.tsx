...
export function JobForm({
  ...
  return (
    <form className="space-y-6" onSubmit={(event) => void handleSubmit(event)}>
      <FieldGroup>
        <Field>
          <FieldLabel htmlFor="processed-text">Job brief</FieldLabel>
          <Textarea
            className="min-h-40"
            id="processed-text"
            value={processedText}
        ...
        <Field>
          ...
          <FieldDescription>
            {editing
              ? "Changing the category keeps the existing checklist and progress."
              : "Optional. Leave blank to start without a checklist."}
          </FieldDescription>
          <Select
            value={categoryId}
          ...
          {!categoryAvailable && (
            <p role="alert" className="text-sm text-destructive">
              This category was removed. Select another or clear it.
            </p>
          )}
          {categoryId !== null && (
            <Button
